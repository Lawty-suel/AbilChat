...
def write_csv(test_labels, pred_labels):
    ...
    #test_file = "F:/ChatEO/Chhh/data/answer/clojurians/test.csv"
    #test_file = "F:/ChatEO/Chhh/data/answer/elmlangB_2017/test.csv"
    #test_file = "F:/ChatEO/Chhh/data/answer/pythondev/test.csv"
    #test_file = "F:/ChatEO/Chhh/data/answer/irc_angularjs/test.csv"
    #test_file = "F:/ChatEO/Chhh/data/answer/irc_opengl/test.csv"
    test_file = "F:/ChatEO/Chhh/data/answer/irc_c++-general/test.csv"
...
def train_test_validate(model, X_tr, Y_tr, X_te, Y_te, sample_weights_train, sample_weights_test):
    ...
    history = model.fit(X_tr, Y_tr, batch_size=256, epochs=60, validation_split=0.2, callbacks=[early_stopping])

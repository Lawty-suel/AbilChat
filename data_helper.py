...
import expand_contractions as expand
...
def prep_data(df_train, df_test, embedding_dim,df_tt):
    ...
    X_test, Y_test, sample_weights_test = create_sets(df_tt, tokenizer, embedding_matrix)
